...
Schema.prototype.custom = function (schema, error_message) {
    return Object.assign(new Schema(), this, {
        type: { value: "custom", desc: schema ? schema : null, message: error_message }
    });
};
...
Schema.prototype.isIn = function (list = [], error_message) {
    return Object.assign(new Schema(), this, { type: { value: "in", message: error_message, list } });
};
Schema.prototype.isBoolean = function (value, error_message) {
    return Object.assign(new Schema(), this, { type: { value: "boolean", message: error_message,bool:value } });
};
Schema.prototype.isUuid = function (error_message) {
    return Object.assign(new Schema(), this, { type: { value: "uuid", message: error_message } });
};
Schema.prototype.isObjectId = function (error_message) {
    return Object.assign(new Schema(), this, { type: { value: "objectId", message: error_message } });
};
